...
import { NavItem, SharedData, SidebarNavItems } from "@/types"
...
function SidebarProvider({
	...
	const getNavItems = (): SidebarNavItems => {
		
		const filterByRole = (items: NavItem[]) =>
			items.filter(item => item.roles.includes("all") || item.roles.includes(auth.user.role));
